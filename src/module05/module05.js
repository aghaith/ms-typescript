...
var BuildArray = /** @class */ (function () {
    ...
    function BuildArray(items, sortOrder) {
        ...
        /* sortAscending is a comparison function that tells the sort method how to sort numbers in ascending order. */
    ...
    BuildArray.prototype.buildArray = function (items, sortOrder) {
        var randomNumbers = [];
        var nextNumber;
